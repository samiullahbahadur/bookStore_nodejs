...
// Use DATABASE_URL if it exists (for Render/Postgres)
if (process.env.DATABASE_URL) {
  sequelize = new Sequelize(process.env.DATABASE_URL, {
    ...
    dialectOptions: {
      ssl: {
        require: true,
        rejectUnauthorized: false, // needed on Render/Postgres
      },
    },
    logging: false,
  });
  ...
  sequelize = new Sequelize(dbName, process.env.DB_USER, process.env.DB_PWD, {
    host: process.env.DB_HOST,
    port: process.env.DB_PORT,
    dialect: process.env.DB_DIALECT,
